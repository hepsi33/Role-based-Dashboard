...
export function AdminDashboardClient() {
    // Session is already checked by the server component parent, 
    // but we can use it for display name if we want, or pass user as prop.
    // Using useSession here is safe for display data as the route is protected.
